...
<div class="text-center">
    <h3 class="mt-5 mb-5">Formulário para visualizar produções</h3>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group mt-4 mb-4">
                    ...
                    <input type="text" class="form-control" name="nome_producao" id="nome_producao" placeholder="Ex.: José Silva" value="<?php echo isset($producoes['nome_producao']) ? $producoes['nome_producao'] : '' ?>" required>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group mt-4 mb-4">
                    ...
                    <select name="metodos_cultivo" class="form-control" id="metodos_cultivo">
                        <?php $metodoCultivo = $producoes['metodos_cultivo'] ?>
                        <?php foreach ($metodos_cultivo as $metodo_cultivo): ?>
                            <option value="<?= $metodo_cultivo['nome_metodo'] ?>" <?= $metodoCultivo == $metodo_cultivo['nome_metodo'] ? 'selected' : '' ?>><?= $metodo_cultivo['nome_metodo'] ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                <div class="form-group mt-4 mb-4">
