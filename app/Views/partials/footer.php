    ...
    <div class="container px-4">
        <div class="row">
            <div class="col-6 col-lg-4">
                <h3 class="pt-3">Gestor do Grão</h3>
                <p class="mb-0">Gestor do Grão</p>
                <p>Minimizando seus gastos, maximizando seus lucros</p>
            </div>
            <div class="col">
        ...
        <div>
            <p class="text-center mb-0">2025 © Gestor do Grão | Todos os direitos reservados</p>
        </div>
    </div>
</footer>
